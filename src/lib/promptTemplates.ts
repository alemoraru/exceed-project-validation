/**
 * Prompt templates for the error handling assistant.
 */
...
/**
 * System prompts for the error handling assistant.
 */
export const systemPrompts = {
    pragmatic: 'You are an assistant helping a Python programmer by briefly explaining the error.',
    contingent: 'You are an educational assistant guiding a Python programmer to successfully resolve their error with clear, supportive, and actionable steps.'
}